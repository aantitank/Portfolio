...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src/AppBundle/Model.Map.BookTableMap';
     ...
     */
    const OM_CLASS = '\\AppBundle\\Model\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src/AppBundle/Model.Book';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Isbn', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'isbn', ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_ID, BookTableMap::COL_TITLE, BookTableMap::COL_ISBN, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'ISBN', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Isbn' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'isbn' => 2, ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_ID => 0, BookTableMap::COL_TITLE => 1, BookTableMap::COL_ISBN => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'ISBN' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AppBundle\\Model\\Book');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AppBundle\Model\Book) { // it's a model object
