...
use \Exception;
use \PDO;
use AppBundle\Model\BookQuery as ChildBookQuery;
use AppBundle\Model\Map\BookTableMap;
...
abstract class Book implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\AppBundle\\Model\\Map\\BookTableMap';
    ...
    /**
     * Initializes internal state of AppBundle\Model\Base\Book object.
     */
     ...
     * @return $this|\AppBundle\Model\Book The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\AppBundle\\Model\\Book'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AppBundle\Model\Book
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AppBundle\Model\Book The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AppBundle\Model\Book (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AppBundle\Model\Book Clone of current object.
     * @throws PropelException
     */
