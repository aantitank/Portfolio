...
use \Exception;
use \PDO;
use AppBundle\Model\Book as ChildBook;
...
abstract class BookQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \AppBundle\Model\Base\BookQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\AppBundle\\Model\\Book', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, title, ISBN FROM book WHERE id = :p0';
        try {
